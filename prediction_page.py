...
def show_predict_page():
    ...
    determine_button = st.button("Predict Heart Failure")
    ...
    if determine_button:
        ...
        if heart_failure_prediction[0] == 0:
            result = "There is a lower likelihood of heart failure."
        elif heart_failure_prediction[0] == 1:
            result = "There is a higher likelihood of heart failure."
        else:
    ...
    st.write("")
    st.write("This program is designed to predict the likelihood of heart failure based on input features provided by the user. It is important to note that the predictions generated by this program are only predictions and should not be considered as a diagnosis.")
    st.write("This program relies on a machine learning algorithm developed with historical data curated by medical doctors at the Hungarian Institute of Cardiology, University Hospital, V.A. Medical Center in Long Beach, and Cleveland Clinic Foundation. It is important to emphasize that the predictions it provides should not replace professional medical advice, diagnosis, or treatment.")
